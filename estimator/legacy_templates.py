...
BASE_ESTIMATE_SYSTEMS: dict[str, LegacySystemRule] = {
    "VAV Boxes w Heat": LegacySystemRule(
        ...
        materials=(
            LegacyMaterialRule("Controller", "Optimizer BACnet MSTP VAV Cntr w Act & VP, Bluetooth, 7 UIO, 5 SSR", 1.0, "VAA-VA75MB24NMC", 281.3558),
            LegacyMaterialRule("Temp Sensor", "TR100 Space with LCD", 1.0, "TR100-T-G", 128.71265),
            LegacyMaterialRule("Temp Sensor", "Duct Insertion Sensor", 1.0, "C7041B2005", 23.18855),
            LegacyMaterialRule("Current Sw", "Digital Status Switch", 0.0, "H600", 31.43),
            LegacyMaterialRule("Relay", "RIB Pilot Relay", 0.0, "RIBU1C", 14.36),
            LegacyMaterialRule("VAV HW Valve 2W & 3-way NSR", "", 0.0, "N/A", 150.0),
            LegacyMaterialRule("Air Flow Monitor", "Retrofit Flow Ring for VAV Boxes", 0.0, "36FMI", 95.0),
        ),
    ),
    "Cooling Only VAV Boxes": LegacySystemRule(
        ...
        materials=(
            LegacyMaterialRule("Controller", "Optimizer BACnet MSTP VAV Cntr w Act & VP, Bluetooth, 7 UIO, 5 SSR", 1.0, "VAA-VA75MB24NMC", 281.3558),
            LegacyMaterialRule("Temp Sensor", "TR100 Space with LCD", 1.0, "TR100-T-G", 128.71265),
            LegacyMaterialRule("Transformer", "40 VA", 0.0, "TR40VA001", 17.76),
            LegacyMaterialRule("Air Flow Monitor", "Retrofit Flow Ring for VAV Boxes", 0.0, "36FMI", 95.0),
        ),
    ),
